/**
 * 
 * The Difference Between [main.js & main-ar.js]
 * 		1- Change Calc Left In [handleLeft Function] From [-] To [+]
 * 		2- Change Arrows Selection [.prev ==> .next] & [.next ==> .prev]
 * 
**/
...
$(function () {
	...
	function slider(sliderClass, itemsToShow, resActiveMd, resActiiveSm) {
		let // Select Elements
			...
			$nextBtn = $sliderContainer.find(".prev"),
			$prevBtn = $sliderContainer.find(".next"),
